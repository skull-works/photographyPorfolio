            ...
            <div className="h-50vh xs:h-54vh sm:h-60vh md:h-100vh md:w-5/12">
                <div className='rectangle-wrapper h-50vh w-7/12  mx-auto pl-0 md:pl-0 pt-8 xss:pt-8 sm:pt-6 md:pt-20'>
                    <div className='rectangle'>
                        ...
                        <img className=" absolute top-0 left-0 object-cover w-full h-full" src={require('../../../images/ArtistPhotos/2Albert.jpg')} alt="sample"/>
                    </div>
                </div>
            </div>
            <div className="h-50vh xs:h-46vh sm:h-40vh md:h-100vh md:w-8/12">
                <div className="w-10/12 xs:w-8/12 md:w-9/12 lg:w-10/12 mx-auto md:mt-20 text-center">
                    <h1 className="leading-tight">
                        <span className="headerAlbert font-Cinzel">Gualbertsan</span> <br /> 
                        <span className="header2 font-Cinzel pl-10vh xss:pl-15vh md:pl-20vh lg:pl-34vh">Sual</span>
                    ...
                    <br />
                     <p className="font-Raleway text-sm xs:text-md md:text-lg lg:text-xl text-justify">
                        Gualbertsan, a digital multimedia artist, explores the intricacies and possibilities of portraiture, 
                        street photography, as well as cinematography.
                        Much of his experience nurtured his fascination with capturing the grittier side of human emotions, 
                        while emphasizing on strong elements of hope and the simple moments in life with cinematic flair.
                    </p>
                </div>
