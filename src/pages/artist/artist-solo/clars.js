            ...
            <div className="h-50vh xs:h-46vh sm:h-40vh md:h-100vh md:w-8/12">
                <div className="w-10/12 xs:w-8/12 md:w-9/12 lg:w-10/12 mx-auto md:mt-20 text-center">
                    <h1 className="leading-tight">
                        <span className="header font-Cinzel">Clarissa</span> <br /> 
                        <span className="header2 font-Cinzel pl-10vh xss:pl-15vh md:pl-20vh lg:pl-34vh">Lorenzo</span>
                    ...
                    <br />
                     <p className="font-Raleway text-sm xs:text-md md:text-lg lg:text-xl text-justify">
                        Clarissa is a multimedia artist that explores the world of visual arts, particularly graphic design, digital and makeup artistry.
