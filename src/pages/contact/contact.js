...
const ContactInputFormDesktop = () => {
    return (
        <div className="w-10/12 md:w-6/12 lg:w-8/12 h-full mx-auto lg:mt-12 lg:flex flex-col albert-color-200">
...
const ContactInputFormBelowDesktop = () => {
    return (
        <div className="flex flex-col w-10/12 md:w-6/12 lg:w-8/12 h-full mx-auto albert-color-200">
            <h1 className="font-Cinzel text-lg md:text-2xl">Contact form</h1>
    ...
    return(
        <div className='albert-color-100'>
            ...
            <main className='content lg:w-10/12 lg:mx-auto lg:h-50vh mt-2 lg:mt-0 lg:flex lg:flex-row'>
                ...
                <div className="mt-8 lg:mt-12 lg:w-4/12 albert-color-200">
            ...
            <footer className="lg:h-38vh">
                ...
                <div className="pt-10 pb-10 lg:pt-4 lg:pb-0 flex flex-col">
                    ...
                    <div className="text-center lg:w-4/12  pt-8 text-xs albert-color-200 mx-auto">
